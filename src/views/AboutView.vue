<template>
  <main>
    <section class="window bg-almost-white rounded-3xl text-purpur border-3 border-purpur sm:w-130 w-full">
      ...
      <p class="p-4 pt-0">I’m a multimedia designer at EASV, who likes to create, design, and code. During my time
        there and
        in my spare
        time, I’ve done a buncha projects, ranging from websites to videos and everything in between. I’m always looking
        for new ways to challenge myself and push the boundaries of what I can create. <br>
    ...
    <section class="window bg-almost-white rounded-3xl text-dark-blue border-3 border-dark-blue w-130">
      ...
      <div class="pb-3 flex justify-end px-4">
        <button
          class="bg-almost-white rounded-2xl border-3 border-dark-blue hover:text-almost-white hover:bg-dark-blue cursor-pointer px-3 py-1 !mx-1 pixelFont">click
          me</button>
        <button
          class="bg-almost-white rounded-2xl border-3 border-dark-blue hover:text-almost-white hover:bg-dark-blue cursor-pointer px-3 py-1 !mx-1 pixelFont">don't
          click me</button>
      </div>
    </section>
  </main>
