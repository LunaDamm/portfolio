<template>
  <main>
    <section
      class="window bg-almost-white rounded-3xl text-purpur border-3 border-purpur sm:w-130 w-full sm:absolute sm:top-2/6 sm:left-4/6 sm:-translate-x-1/2 sm:-translate-y-1/2 !mb-4">
    ...
    <section
      class="window bg-almost-white rounded-3xl text-dark-blue border-3 border-dark-blue sm:w-80 w-full sm:absolute sm:top-5/10 sm:left-4/13 sm:-translate-x-1/2 sm:-translate-y-1/2 !mb-4">
